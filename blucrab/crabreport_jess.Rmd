...
load(file.path(root, "crab.RData")) # boats is name of data frame with all of the blue crab data
tow <- tows %>%
...
crab <- read.csv(file.path(root, "BLUE CRAB TOTALS.csv"))
...
crab <- read.csv(file.path(root, "Blue Crab catch.csv"))
crab$date <- as.POSIXct(strptime(crab$Date, "%m/%d/%Y"))
...
totln <- read.csv(file.path(root, "BlueCrab_LENGTHS.csv"))
```
...
crab <- read.csv(file.path(root, "River Herring Seine Blue Crab Data_catch.csv"))
crab_effort <- read.csv(file.path(root, "River Herring Seine Blue Crab Data_head.csv", blank.lines.skip = T))
...
len <- read.csv(file.path(root, "River Herring Seine Blue Crab Data_length.csv"))
