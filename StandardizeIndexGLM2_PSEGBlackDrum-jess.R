...
indir <- "C:/Users/jgorzo/OneDrive - New Jersey Office of Information Technology/Documents/BlackDrum/BlackDrum/PSEG Black Drum"	#==>change to indirectory where input file located
source(file.path(indir,"HighstatLibV13.R"))	#==>change path as needed; contains 'corvif' function
file1 <- "C:/Users/jgorzo/OneDrive - New Jersey Office of Information Technology/Documents/BLACK DRUM-catch_Beach Seine.csv"			#==>change file name as needed
...
blk <- read.csv("C:/Users/jgorzo/OneDrive - New Jersey Office of Information Technology/Documents/BLACK DRUM_length.csv")
