...
my_layer <- my_layer[my_layer$FEAT_DESC=="Foraging",]
ospr <- sf::st_centroid(my_layer)
...
towny <- towns[towns$MUN %in% c("WILDWOOD CREST BORO", "STONE HARBOR BORO", "SEA ISLE CITY", "AVALON BORO"),]
...
mapview(co, zcol="COUNTY", col.regions="red") +
  mapview(rivers, zcol="WMA_NAME") + mapview(sedge, col.regions="orange") +
  mapview(great) + mapview(towny, zcol="MUN", col.regions=c("aliceblue", "antiquewhite", "antiquewhite1", "antiquewhite2")) + mapview(ospr)
```
