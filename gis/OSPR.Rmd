...
knitr::oospr_chunk$set(echo = FALSE, message=FALSE, warning=FALSE)
library(mapview)
...
mapview(co, zcol="COUNTY", col.regions="red") +
  ...
  mapview(great) + mapview(towns, zcol="MUN", col.regions=c("aliceblue", "antiquewhite", "antiquewhite1", "antiquewhite2")) + mapview(ospr)
```
